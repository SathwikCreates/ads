            ...
            <div className="container mx-auto px-6 flex flex-col items-center text-center">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 md:gap-12 max-w-6xl mx-auto items-center justify-items-center">
                    {logos.map((logo) => (
                        <div
                            key={logo.id}
                            className="flex items-center justify-center opacity-40 hover:opacity-100 transition-all duration-300 hover:scale-110 cursor-pointer"
                        >
                            <logo.component className="h-8 md:h-10 w-auto text-slate-800" />
                        </div>
                    ))}
                </div>
            </div>
